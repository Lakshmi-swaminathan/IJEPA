...
from tensorflow.keras.applications import VGG16, MobileNetV2, EfficientNetB2
...
class EfficientNetEncoder(BaseEncoder):
    """
    Concrete implementation of BaseEncoder using the EfficientNetB2 architecture.
    """

    def create_encoder(self):
        """
        Creates an EfficientNet-based encoder without the fully connected layers.

        Returns:
            Model: A Keras model for EfficientNetB2 without the top layers, 
                   with global average pooling added.
        """
        # Load EfficientNetB2 model with pretrained weights
