...
class MobileNetV2Predictor(BasePredictor):
    """
    Concrete implementation of BasePredictor for use with MobileNetV2 encoders.

    This class defines the predictor architecture specific to MobileNetV2-style encodings.
    """

    def __init__(self):
        """
        Initializes the MobileNetV2Predictor with the input shapes for context and coordinates.
        """
        super().__init__((1280,), (4,))

    def define_architecture(self, inputs):
        """
        Defines the architecture for the MobileNetV2 predictor model.
        ...
        # Output layer
        output = Dense(1280, activation='relu', name='output_vector')(x)
        return output
